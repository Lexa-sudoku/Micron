    ...
    try:
        ...
        for product in products:
            try:
                ...
                # Артикул
                article = product.find_element(By.XPATH,
                                               ".//tr[contains(@class, 'prd_attrs__tr--code')]/td[contains(@class, 'prd_attrs__td--val')]/span").text.strip()
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        # products_platan, products_dip8, products_radiocomplect, products_chipster, products_chipdip, products_mirekom = results
        products_chipster = results
